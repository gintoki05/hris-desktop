...
pub fn run() {
    let result = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::attendance_summary::list_attendance_summaries_by_period,
            ...
            commands::payroll::get_latest_manual_payroll_before,
            ...
            commands::payslip_manager::delete_payslip_period,
            commands::payslip_portal_publish::publish_final_payslips_to_portal,
            commands::payslip_portal_publish::get_owner_summary_publish_status,
